...
const Colagem = () => {
    ...
    useEffect(() => {
        ...
        const loadImages = async () => {
            const images = await Promise.all([sub1(),sub2(),sub3(),sub4(),   sub5(),]);
    ...
    return (
        <div className='grid justify-center items-center my-28 pb-32'>
            ...
            <Card 
            imageData={sub}
            textOverlay='Submundo abaixo dos pés, vento frio rasga o rosto
                        Onde gotas salgadas passeam no olhar de desgaste e desgosto
                        A pele carvonizada, a lua e a boca esbranquiçada
                        Semelhantes enredos de dor espetada, que forçam a retomar suas canções
                        O som dos prantos, impulsiona e embala as embarcações
                        Sob paredões molhados, pesados tal qual os tijolos em suas nações
                        Passado pesando, pensando, revendo contratos
                        Foi atrasado, e seu retrato retrata seu fardo.

                        Mar Negro | Colagens Manuais e Poema, 2018.
                        
                        A Europa não quer refugiados, não se responsabiliza pelo passado colonial nem pelo presente de exploração e guerras!
                        Doe: acnur.org/br'
            />

            <div className='mt-52'>
                  <Card 
                  imageData={revistabibiana} 
