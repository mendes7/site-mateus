  ...
  return (
    <div className='mx-auto max-w-6xl my-8 space-y-12'>
        <div className='text-center text-justify'>
          ...
          A arte sempre esteve presente no meu cotidiano, graças à influência da minha mãe, que pintava quadros, personalizava móveis e levava sua criatividade até para a cozinha. Essa convivência me inspirou desde cedo a explorar diferentes formas de expressão artística.
          ...
          Meu processo criativo envolve garimpo, seleção de recortes, criação, testes e composição dando origem a imagens únicas. Combino, também, a fotografia analógica e técnicas mistas.
          </p>
        </div>
    </div>
  );
